...
$(document).ready(function () {
	...
	$("#message").html("<img src=\"Assets/upload/index_65.jpg\"   alt=\"\"/>\n" +
		"   <br/>\n" +
		"   <div class='cp_font'><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;郴州市加贝装饰工程有限公司位于福城—郴州市，公司秉承着提供“家倍美好”生活的品牌文化理念，围绕“客户价值”、打造了“从房到家”的房地产生态链。<br/>\n" +
		"2019年，加贝公司依托良好的市场基础启动了“我爱我家”互联网+智慧社区融合服务平台项目建设，聚焦智慧社区，致力于创造智慧社区生活。<br/>\n公司运营的“我爱我家”智慧社区整体解决方案，其顶层设计基于移动互联网、物联网和大数据三大核心技术，是实现智慧物业管理、智能安防硬件、智慧社区全媒体广告、智慧社区生活服务平台和超级智能管家等多个服务平台融合的系统。<br/>\n" +
...
function message(num) {
	if(num == 1){
		...
		$("#message").html("<img src=\"Assets/upload/development planning.jpg\"   alt=\"\"/>\n" +
			"   <br/>\n" +
			"   <div class='cp_font'><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目前，“我爱我家”—互联网+智慧社区融合服务平台建设项目正处在立项阶段，公司将市场定位于立足湖南，辐射全国的战略布局，并将采取“因地制宜”“不断创新”的方法来保持我们的独特的定位，力争成为智慧社区平台服务解方案领域的佼佼者。加贝未来的发展规划分为三个阶段，分别是：<br/>"+
