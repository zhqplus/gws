...
$(document).ready(function () {
	...
	$("#message").html("<img src=\"Assets/upload/pic8.jpg\" width=\"410\" height=\"180\" alt=\"\"/>\n" +
		"   <br/>\n" +
		"   <p style=\"clear:both; margin-top:20px;\">第一部分：公司名称服务中心  更多模板：源码之家定位及建设目标：包括区域城市现状及趋势分析、服务中心改造定位、服务中心建设目标。</p >\n" +
...
function message(num) {
	if(num == 1){
		...
		$("#message").html("<img src=\"Assets/upload/智桂琴.jpg\" width=\"1200px\" height=\"180px\" alt=\"\"/>\n" +
			"   <br/>\n" +
			"   <p style=\"clear:both; margin-top:20px;\">第一部分：公司名称服务中心  更多模板：<源码之家></源码之家>定位及建设目标：包括区域城市现状及趋势分析、服务中心改造定位、服务中心建设目标。</p >\n" +
			"   <p>第二部分：服务中心运营体系：包括服务中心平台架构、服务中心品牌体系两个方面</p >\n" +
			"   <p>第三部分：服务中心服务平台：包括基础硬件升级改造、服务平台落地、项目工作推进规划三个方面</p >");
	}else if(num == 2){
		...
		$("#button3").removeClass("active");
		$("#message").html("<img src=\"Assets/upload/06bcef36f7cbbcd3b1a1ef2717000ea.jpg\" width=\"410\" height=\"180\" alt=\"\"/>\n" +
			"   <br/>\n" +
			"   <p style=\"clear:both; margin-top:20px;\">第一部分：公司名称服务中心  更多模板：< a href=\" \" target=\"_blank\">源码之家</ a>定位及建设目标：包括区域城市现状及趋势分析、服务中心改造定位、服务中心建设目标。</p >\n" +
			"   <p>第二部分：服务中心运营体系：包括服务中心平台架构、服务中心品牌体系两个方面</p >\n" +
			"   <p>第三部分：服务中心服务平台：包括基础硬件升级改造、服务平台落地、项目工作推进规划三个方面</p >");
	}else{
